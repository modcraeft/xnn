## TODO
```
TODO: THOUGHTS: Back to pipelining -- Need some kind of orchestration.  
```
```
...
UPDATE: Yet to implement UI update. Considering Orchestration paradigm. Did fix the crashing tho...
```
